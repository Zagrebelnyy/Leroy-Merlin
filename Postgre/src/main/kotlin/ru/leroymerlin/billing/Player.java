...
public class Player extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
    private static final long serialVersionUID = -3523252055011876165L;
    public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Player\",\"namespace\":\"ru.leroymerlin.billing\",\"doc\":\"Player object\",\"fields\":[{\"name\":\"name\",\"type\":\"string\",\"doc\":\"Name\",\"default\":\"null\"},{\"name\":\"age\",\"type\":\"int\",\"doc\":\"Age\",\"default\":-1}]}");
     ...
     * @param age Age
     */
    public Player(java.lang.CharSequence name, java.lang.Integer age) {
        this.name = name;
        this.age = age;
    }
     ...
     */
    public static ru.leroymerlin.billing.Player.Builder newBuilder() {
        return new ru.leroymerlin.billing.Player.Builder();
    }
     ...
     * @return A new Player RecordBuilder
     */
    public static ru.leroymerlin.billing.Player.Builder newBuilder(ru.leroymerlin.billing.Player.Builder other) {
        return new ru.leroymerlin.billing.Player.Builder(other);
    }
     ...
     * @return A new Player RecordBuilder
     */
    public static ru.leroymerlin.billing.Player.Builder newBuilder(ru.leroymerlin.billing.Player other) {
        return new ru.leroymerlin.billing.Player.Builder(other);
    }
    ...
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Player>
         ...
         * @param other The existing Builder to copy.
         */
        private Builder(ru.leroymerlin.billing.Player.Builder other) {
            super(other);
         ...
         * @param other The existing instance to copy.
         */
        private Builder(ru.leroymerlin.billing.Player other) {
            super(SCHEMA$);
            if (isValidValue(fields()[0], other.name)) {
                this.name = data().deepCopy(fields()[0].schema(), other.name);
                fieldSetFlags()[0] = true;
         ...
         * @return This builder.
         */
        public ru.leroymerlin.billing.Player.Builder setName(java.lang.CharSequence value) {
         ...
         * @return This builder.
         */
        public ru.leroymerlin.billing.Player.Builder clearName() {
            name = null;
         ...
         * @return This builder.
         */
        public ru.leroymerlin.billing.Player.Builder setAge(int value) {
         ...
         * @return This builder.
         */
        public ru.leroymerlin.billing.Player.Builder clearAge() {
